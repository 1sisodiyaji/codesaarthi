...
const PortfolioHtml = () => {
    return (
        ...
        <Helmet>
                ...
                <link rel="canonical" href="https://codesaarthi.com/Projects/PortfolioHtml" />
                ...
                <title>Portfolio page  | CodeSaarthi</title>
                <meta property="og:title" content="Portfolio page | CodeSaarthi" />
                ...
                <meta property="og:image" content="https://codesaarthi.com/img/portfolio1.jpg" />
                <meta property="og:url" content="https://codesaarthi.com/Projects/PortfolioHtml" />
            ...
            <div className="" style={{ backgroundColor: '#000000' }}>
                <div className=" container-lg conatiner-sm-fluid design g-0 p-2 py-lg-5">
                    ...
                    <div className="row my-3">
                        <div className="col-6 "><img src="https://codesaarthi.com/img/portfolio1.jpg" alt="html project images" title='first page of portfolio'  loading = "lazy" className="img-fluid" /></div> 
                        <div className="col-6"><img src="https://codesaarthi.com/img/portfolio2.jpg" alt="html project images" title='second view of portfolio' loading='lazy' className="img-fluid" /></div>
                    </div>
    ...
    &lt;/html&gt;<br/>
                    ...
                    <div className="row">
                        <div className="col-4 text-center">
                            <Link to="/Projects/AssignmentProject" className="btn bg-dark text-warning text-capitalize">Assingment page <i className="fi fi-rr-arrow-up-left-from-circle ps-2"></i></Link>
                        </div>
                        <div className="col-4 text-center">
                            <Link to="/Projects/ProductCatalog" className="btn bg-dark text-warning text-capitalize">Product Catalog <i className="fi fi-rr-arrow-up-left-from-circle ps-2"></i></Link>
                        </div>
                        <div className="col-4 text-center">
                            <Link to="/Projects/youtubeBasedProject" className="btn bg-dark text-warning text-capitalize">Youtube Based  <i className="fi fi-rr-arrow-up-left-from-circle ps-2"></i></Link>
                        </div>
                    </div>
