...
const HireMe = () => {
    return (
        <>
      <Helmet>
        <meta name="keywords" content="Hire Me button , Hire Me Design , Hire Button Design " />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://codesaarthi.com/Projects/Hire-Me" />
        <meta name="description" content="It is an page where we will create the hire button design an simpl deisgn of hire button. " />
        <title>Hire Me | Codesaarthi</title>
        <meta property="og:title" content=" Hire Me | Codesaarthi " />
        <meta property="og:description" content=" It is an page where we will create the hire button design an simpl deisgn of hire button.  " />
        <meta property="og:image" content="https://codesaarthi.com/img/HireMe.jpg" />
        <meta property="og:url" content="https://codesaarthi.com/Projects/Hire-Me" />
        ...
        <link rel="icon" type="image/png" href="https://codesaarthi.com/img/favicon.ico" sizes="32x32" />
            ...
            <div className="" style={{ backgroundColor: '#000000' }}>
                <div className=" container-lg conatiner-sm-fluid design g-0 p-2 py-lg-5">
                    ...
                    <h5 className='textColor'> Project Title : Hire Me Button</h5>

                    <h6 className='textColor'>Description:</h6>
                    <p className='text-light'>
                       Basically this is a project of creating an simple design of hire me button where you can use it as a component in your app as an basic design of hire me button.
                    </p>
                    ...
                    <div className="row my-3">
                        <div className="col-lg-6 col-12 "><img src="../img/HireMe.jpg" alt="chair images " title='chair' loading='lazy' className="img-fluid" /></div>
                    </div>
                    ...
                    <ol className='text-light'>
                        <li>Clone : you have to clone the project from Github <br />
                            ```bash <br />
                            https://github.com/1sisodiyaji/Hire_Me-Button.git <br />
                            <Link to="https://github.com/1sisodiyaji/Hire_Me-Button.git" target='blank'>Click Here</Link>
                        </li>
                    ...
                    <div className="d-flex justify-content-between my-3 ">
                        <Link to="https://hire-me-button-dusky.vercel.app" target='blank' className="btn border bg-dark text-warning rounded-6">View Demo Link <i class="fi fi-sr-share-square ps-2"></i></Link>
                        <Link to="https://github.com/1sisodiyaji/Hire_Me-Button.git" target='blank' className="btn border bg-dark text-warning rounded-6"> <i class="fi fi-sr-location-arrow pe-2"></i> Github Code link</Link>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-4 text-center">
                            <Link to = "/Projects/Reciepe-website" className="btn bg-dark text-warning text-capitalize">Recipe Website <i class="fi fi-rr-arrow-up-left-from-circle ps-2"></i></Link>
                        </div>
                        <div className="col-4 text-center">
