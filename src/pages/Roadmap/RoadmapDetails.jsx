      ...
      <div className="container-fluid-sm container">
        <div className="row g-0">
          ...
          <div className="col-lg-4 col-1 d-flex align-self-center justify-content-end">
            <i className={`fi ${isOpen ? 'fi-rr-angle-small-up' : 'fi-rr-angle-small-down'} text-warning`} onClick={toggleOpen}></i>
          </div>
        </div>
  ...
  return (
    ...
    <ToastContainer />
      <Helmet>
        ...
        <meta name="keywords" content="Roadmaps , CS Theory Roadmap , Best Roadmap , Top 5 Roadmap , free Roadmaps" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href={`https://codesaarthi.com/roadMap/${title}`} />
        ...
        <meta property="og:description" content={`${roadmapData.description}`} />
        <meta property="og:image" content={roadmapData.thumbnail} />
        <meta property="og:url" content={`https://codesaarthi.com/roadMap/${title}`} />
