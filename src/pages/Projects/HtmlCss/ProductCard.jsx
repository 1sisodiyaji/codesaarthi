        ...
        <link rel="icon" type="image/png" href="https://codesaarthi.com/img/favicon.ico" sizes="32x32" />
            ...
            <div className="" style={{ backgroundColor: '#000000' }}>
                <div className=" container-lg conatiner-sm-fluid design g-0 p-2 py-lg-5">
                    ...
                    <h5 className='textColor'> Project Title : Product Card</h5>

                    <h6 className='textColor'>Description:</h6>
                    <p className='text-light'>
                       Basically this is a project based on a Product Card  of coffee mug as a example as making an responsive design of coffee mug as product .
                    </p>
                    ...
                    <div className="row my-3">
                        <div className="col-lg-6 col-12 "><img src="../img/productCard.jpg" alt="coffee mug " title='coffee mug pics' loading='lazy' className="img-fluid" /></div>
                    </div>
                    ...
                    <ol className='text-light'>
                        <li>Clone : you have to clone the project from Github <br />
                            ```bash <br />
                            https://github.com/1sisodiyaji/Product_Card2.git <br />
                            <Link to="https://github.com/1sisodiyaji/Product_Card2.git" target='blank'>Click Here</Link>
                        </li>
                    ...
                    <div className="d-flex justify-content-between my-3 ">
                        <Link to="https://product-card2-ruby.vercel.app" target='blank' className="btn border bg-dark text-warning rounded-6">View Demo Link <i class="fi fi-sr-share-square ps-2"></i></Link>
                        <Link to="https://github.com/1sisodiyaji/Product_Card2.git" target='blank' className="btn border bg-dark text-warning rounded-6"> <i class="fi fi-sr-location-arrow pe-2"></i> Github Code link</Link>
                    </div>
