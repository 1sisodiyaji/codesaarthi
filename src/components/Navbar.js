  ...
  return (
    <>
      <div className={cn("fixed top-10 inset-x-0 max-w-7xl mx-auto z-50 h-12 hidden md:flex justify-between", className)}>
       ...
       <Link to="/" className="flex justify-center items-center space-x-2"> <img src="https://codesaarthi.com/logo.png" className="w-12 h-12" alt="logo"/>
       <h1 className="md:text-3xl text-black"> Codesaarthi</h1></Link> 
