                ...
                <div className=" container-lg conatiner-sm-fluid design g-0 p-2 py-lg-5">
                    ...
                    <div className="row">
                        <div className="col-4 text-center">
                            <Link to="/Projects/FunCalculations" className="btn bg-dark text-warning text-capitalize">Fun Calculations <i className="fi fi-rr-arrow-up-left-from-circle ps-2"></i></Link>
                        </div>
                        <div className="col-4 text-center">
