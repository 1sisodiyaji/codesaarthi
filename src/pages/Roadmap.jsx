  ...
  return (
    <>
      <Helmet>
        ...
        <title>Roadmaps: DSA, OS, DBMS, CN , java , Javascript , Pyhton | codesaarthi</title>
        <meta property="og:title" content="Subject Roadmaps: DSA, OS, DBMS, CN ,java , Javascript , Pyhton | codesaarthi" />
      ...
      <div className="container-fluid py-5 design d-lg-none d-md-none d-block" style={{ backgroundColor: '#1E1E1E' }}>
        ...
        <div className="col-6  text-start"><div className="ms-2" onClick={prevCards}><i class="fi fi-sr-angle-circle-left text-warning" style={{fontSize:'2rem', cursor:'pointer'}}></i></div></div>

        <div className="col-6 text-end"><div className="mx-1" onClick={nextCards}><i class="fi fi-sr-angle-circle-right text-warning" style={{fontSize:'2rem', cursor:'pointer'}}></i></div></div>
      ...
      <div className="container-fluid py-5 design d-lg-block d-md-block d-none" style={{ backgroundColor: '#1E1E1E' }}>
        <div className="container py-5">
          <div className="row">
          <div className="col-1 d-flex justify-content-center align-items-center"><div className="mx-1" onClick={prevCards}><i class="fi fi-sr-angle-circle-left text-warning" style={{fontSize:'2rem', cursor:'pointer'}}></i></div></div>
          <div className="col-10">
            <div className="row">
            {renderCards()}
            </div>
           </div>
            <div className="col-1 d-flex justify-content-center align-items-center"><div className="mx-1" onClick={nextCards}><i class="fi fi-sr-angle-circle-right text-warning" style={{fontSize:'2rem', cursor:'pointer'}}></i></div></div>
          </div>
        </div>
      </div>
