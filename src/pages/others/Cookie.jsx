  ...
  return (
    <>
      <Helmet>
        <meta
          name="keywords"
          content="Cookie Policy, Cookies, Privacy, Data Collection, User Experience"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://codesaarthi.com/cookies" />
        <meta
          name="description"
        ...
        <div className="max-w-7xl m-auto"> 
              ...
              <ul>
                <li>
                  ...
                  "Our" in this Cookies Policy) refers to codesaarthi .
                </li>
                <li>
              ...
              <p>
                ...
                LinkedIn features and functionality. Any browser visiting our
                sites may receive cookies from us or cookies from third parties
                such as our customers, partners or service providers. We or
                third parties may also place cookies in your browser when you
                visit non-LinkedIn sites that display ads or that host our
                plugins or tags.
              </p>
              ...
              <p>
                If you register with us or if you continue to use the platforms,
                you agree to our use of cookies. In some cases, when you arrive
                on the platform a pop-up message will appear asking for your
                consent to place advertising cookies on your device as required
                by applicable law. In order to provide your consent, please
                click ‘OK’. Once your consent has been provided, this message
                will not appear again when you revisit, unless you delete
                cookies via your browser settings or otherwise.
              </p>
              <div className="lh-1">
                <p>
              ...
              <p>
                <b>Purpose:</b> These Cookies are used to track information
                ...
                Website to see how our users react to them. Your Choices
                Regarding Cookies
              </p>
              ...
              <ul>
                ...
                <ul>
                  ...
                  <li>
                    For the Microsoft Edge web browser, please visit this page
                    from Microsoft:{" "}
