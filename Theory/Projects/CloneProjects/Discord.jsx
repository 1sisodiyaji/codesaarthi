  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://codesaarthi.com/Projects/Discord" />
        ...
        <title>Discord Clone | Codesaarthi</title>
        <meta property="og:title" content="Discord Clone | Codesaarthi" />
        ...
        <meta property="og:url" content="https://codesaarthi.com/Projects/Discord" />
      ...
      <div className="" style={{ backgroundColor: '#000000' }}>
        <div className="container-lg container-sm-fluid design g-0 p-2 py-lg-5">
          ...
          <div className="row my-3">
            <div className="col-6 "><img src="https://codesaarthi.com/img/Discord1.jpg" alt="" className="img-fluid" /></div>
            <div className="col-6"><img src="https://codesaarthi.com/img/Discord2.jpg" alt="" className="img-fluid" /></div>
          </div>
          ...
          <div className="d-flex justify-content-between my-3 ">
            ...
            <Link to="https://d-iscord-indol.vercel.app/" target='blank' className="btn border bg-dark text-warning rounded-6">View Demo Link <i className="fi fi-sr-share-square ps-2"></i></Link>
            <Link to="https://github.com/1sisodiyaji/DIscord.git" target='blank' className="btn border bg-dark text-warning rounded-6"> <i className="fi fi-sr-location-arrow pe-2"></i> Github Code link</Link>
          </div>
