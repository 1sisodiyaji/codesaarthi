  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Profile page of users in codesaarthi , Defining the profile page of users."
        />
        ...
        <meta
          property="og:url"
          content={`https://codesaarthi.com/Profile/{user._id}`}
        />
      ...
      <div className="py-lg-5 design py-3" style={{ minHeight: "100vh" }}>
        {user ? (
          <>
            <div className="text-end pe-4 d-lg-block d-md-block d-none">
              <button className="btn   text-capitalize" onClick={logout}>
                Logout
              </button>
            </div>
                      ...
                      <div className="col-lg-9 col-12 ps-lg-3 my-3">
                        ...
                        <div className="row">
                          <div className="col-6 text-start">
                            <button
                              type="submit"
                              className="btn  bg-danger text-light text-capitalize"
                              disabled={loading}
                            ...
                            >
                              {loading ? (
                                ...
                                <>
                                  Delete{" "}
                                  <i className="fi fi-ss-trash-xmark ps-2"></i>
                                </>
                              )}
                            </button>
                          </div>
                          ...
                          <div className="col-6 text-end">
                            <button
                              type="submit"
                              className="btn bg-dark text-warning text-capitalize"
                              disabled={loading}
                            >
                              {loading ? (
                                "Updating..."
                                ...
                                <>
                                  Update{" "}
                                  <i className="fi fi-sr-pen-clip ps-2"></i>
                                </>
                              )}
                            </button>
                          </div>
                ...
                <div className="card bg-black p-lg-4  p-2 m-lg-3 m-0">
                  <div className="row d-flex justify-content-end g-0">
                    ...
                    <div className="col-6 text-end">
                      ...
                      >
                        {" "}
                        Edit <i className="fi fi-sr-user-pen fa-2x ps-2"></i>
                      </div>{" "}
                    </div>
                  </div>
                  ...
                  <div className="row g-0 ">
                    <div className="col-3">
                      <img
                        src={user.image ? user.image : 'https://res.cloudinary.com/ducw7orvn/image/upload/v1721024136/codesaarthi/article-1721024134471.png'}
                        alt={user.name}
                        title={user.name}
                        className="img-fluid border border-light p-1"
                        width={250}
                        height={250}
              ...
              <>
                <div className="p-1">
                  {blogs.map((blog) => (
                    <div
                      key={blog._id}
                      className="card bg-black my-2 shadow-6 p-3 "
                    >
          ...
          <>
            <h6>
              No User Found , Please <Link to="/login"> Login </Link>
            </h6>
          </>
        )}
      </div>
