...
const BasicDbms = () => {
  ...
  // Function to handle selecting the previous topic
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://codesaarthi.com/basic-Dbms" />
        ...
        <meta property="og:url" content="https://codesaarthi.com/basic-Dbms" />
      ...
      <div class="container-fluid design g-0" style={{ backgroundColor: '#1E1E1E' }}>
        <div className="container">
          ...
          <h1 class='py-2 text-success text-decoration-underline'>DBMS  <i className="fi fi-ss-back-up"></i></h1>
