...
const Cn_Content = () => {
  ...
  return (
    <>
      <Helmet>
        <meta name="keywords" content="Computer networks , learn computer networks from scratch . Computer networks interview preparation questions ." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://codesaarthi.com/theory/Cn-Content" />
        <meta name="description" content="Learn Computer Networks as in easy language from scratch for better understanding . easy to undersatnd the structure of networking and osi model for better enhancement in acknowledge the https request ." />
        <title></title>
        <meta property="og:title" content="" />
        <meta property="og:description" content="Learn Computer Networks as in easy language from scratch for better understanding . easy to undersatnd the structure of networking and osi model for better enhancement in acknowledge the https request ." />
        <meta property="og:image" content="https://codesaarthi.com/img/logo.png" />
        <meta property="og:url" content="https://codesaarthi.com/theory/Cn-Content" />
        ...
        <div className="container">
          ...
          <div className="row g-0 p-lg-2 p-0 border border-dark">
            ...
            <div className="col-lg-3 col-0 p-lg-2 p-0 d-lg-block d-none border border-dark" style={{ backgroundColor: '#262626' }} >
              ...
              <img src="https://codesaarthi.com/img/cnLogo.png" className="img-fluid" alt="java logo" />
              </div>
              <h2 className="text-center pb-3 text-primary">Computer Networks</h2>
