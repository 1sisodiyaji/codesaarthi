...
const Profile = () => {
  ...
  const [imagePreview, setImagePreview] = useState(user ? user.image : "https://res.cloudinary.com/ducw7orvn/image/upload/v1720990203/logo_zdeshk.png");
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta property="og:image" content={user.image ? user.image : 'https://res.cloudinary.com/ducw7orvn/image/upload/v1720990203/logo_zdeshk.png'} />
